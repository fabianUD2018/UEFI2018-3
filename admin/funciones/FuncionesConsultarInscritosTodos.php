<?php
		...
		function consultarInscritosTodos(){
		...
		echo "<tbody>";
			...
			$consulta = "select `idpersonainscrita`, `nombreinscrito`, `apellidoinscrito`, `idtipodocumento`, `numerodocumento`, `telefonocelular`, `email` from `personainscrita`";
			...
			echo "</table>";
				...
				$mensajeInscritos = "No hay Inscritos en la base de datos";
