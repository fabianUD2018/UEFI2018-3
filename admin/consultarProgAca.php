...
<head>
	<meta charset="UTF-8">
	<title>Consultar Programas Académicos</title>
  ...
  <div class="wrapper">
    ...
    <div class="container">
      <div class="row d-flex justify-content-center">
        <div class="col-six">
          <form method="post" action="RespuestaConsultaCursos.php" enctype="multipart/form-data">
          <button type="submit" class="btn btn-primary btn-lg">Consultar Cursos</button>
          </form>
        </div>
        <div class="col-six">
          <form method="post" action="RespuestaConsultaDiplomados.php" enctype="multipart/form-data">
          <button type="submit" class="btn btn-secondary btn-lg">Consultar Diplomados</button>
          </form>
        </div>
      </div>
    </div>
