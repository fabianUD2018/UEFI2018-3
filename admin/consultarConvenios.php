...
<head>
	<meta charset="UTF-8">
	<title>Consultar Convenios</title>
...
<body>
  ...
  <?php include 'funciones/FuncionesConsultarConvenio.php';?>
	<!--Código de consultas a la BD-->
  ...
  <div class="wrapper">
    ...
    <div class="container">
      <div class="row-12">
        <h3 class="section-title text-center">Consultar Convenio Interadministrativo</h3>
      </div>
      <div class="row">
        <?php consultarConvenios(); ?>
      </div>
